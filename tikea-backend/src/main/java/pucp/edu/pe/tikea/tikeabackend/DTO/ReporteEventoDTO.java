...
public class ReporteEventoDTO {
    ...
    private Long totalIngresos; // La suma de los precios
    // (Opcional) private List<String> promocionesActivas;

    // Constructor especial para la consulta JPQL (Paso 3)
    public ReporteEventoDTO(Integer idEvento, String nombreEvento, Long totalTicketsVendidos, Long totalIngresos) {
